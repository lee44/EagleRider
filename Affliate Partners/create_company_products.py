...
def create_company_products(page, company_name):
    ...
    for product in products:
        ...
        page.locator("select[name=\"company_product[company_id]\"]").select_option(label=company_name+' White Label')
        ...
        if product == 'Bike':
            page.locator(
                "select[name=\"company_product[commission_calculation_method_id]\"]").select_option(value="1")
        else:
            page.locator(
                "select[name=\"company_product[commission_calculation_method_id]\"]").select_option(value="2")
